document.addEventListener("DOMContentLoaded", () => {
    ...
    const enlacesNavegacion = document.querySelectorAll(".navegacion-principal a, .navegacion-movil a")
    enlacesNavegacion.forEach((enlace) => {
        if (enlace.href.includes("?categoria=")) {
    ...
    if (categoriaParam && window.location.pathname.includes("catalogo.html")) {
        // Esperar a que se cargue el catálogo y luego aplicar el filtro
        setTimeout(() => {
            const filtroBtn = document.querySelector(`[data-categoria="${categoriaParam}"]`)
            if (filtroBtn) {
